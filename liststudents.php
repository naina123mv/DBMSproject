...
if ($result->num_rows > 0) {
    ...
    echo "<table>"; 
        ...
        echo "<tr><th>Registration No</th><th>Name</th><th>DateOfBirth</th><th>RoomNo</th><th>Contact</th></tr>";
        while($row=$result->fetch_assoc())
        {  
                echo "<tr><td>" . $row['RegNo'] . "</td><td>". $row['Name'] . "</td><td>". $row['Dob'] . "</td><td>". $row['RoomNo'] . "</td><td>".$row['PhoneNo'] . "</td></tr>";  
        }
        echo "</table>"; 
} 
else {
